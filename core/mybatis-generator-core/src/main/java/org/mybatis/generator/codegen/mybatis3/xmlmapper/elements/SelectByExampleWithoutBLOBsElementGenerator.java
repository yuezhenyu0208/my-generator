...
public class SelectByExampleWithoutBLOBsElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        ifElement.addAttribute(new Attribute("test", XmlConstants.XML_EXAMPLE_PERFIX+"distinct")); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        ifElement.addAttribute(
            new Attribute("test", "example.orderByClause != null")); //$NON-NLS-1$ //$NON-NLS-2$
