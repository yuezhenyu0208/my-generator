...
public abstract class IntrospectedTable {
     ...
     * Note that the value will be calculated regardless of whether the table has these columns or
     * not.
     */
    ...
    public String getFullyQualifiedTableNameAtRuntime() {
        return XmlConstants.XML_APPKEY + internalAttributes
     ...
     *
     * @param aliasedFullyQualifiedRuntimeTableName the new sql map aliased fully qualified runtime
     * table name
     */
    ...
    public boolean isConstructorBased() {
        ...
        if (tableConfiguration.getProperties()
